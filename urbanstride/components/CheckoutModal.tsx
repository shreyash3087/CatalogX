...
export default function CheckoutModal({ isOpen, onClose, product, selectedSize }: Props) {
    ...
    try {
      ...
      const res = await fetch('/api/orders', {
        ...
        body: JSON.stringify({
          ...
          size: selectedSize || product.sizes[0] || '8',
          quantity: 1,
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm animate-fade-in">
      <div className="bg-[#0e1422] border border-slate-800 rounded-3xl p-6 sm:p-8 max-w-lg w-full text-white shadow-2xl relative">
        <button
          onClick={onClose}
        ...
        {orderSuccess ? (
          <div className="text-center py-6 space-y-4">
            ...
            <button
              ...
              className="w-full py-3 rounded-xl bg-orange-500 hover:bg-orange-600 font-bold text-xs"
            >
              Done
            </button>
          </div>
          ...
          <form onSubmit={handlePay} className="space-y-4">
            <div className="flex items-center gap-3 pb-3 border-b border-slate-800">
              ...
              <div>
                ...
                <div className="text-xs text-slate-400">
                  Size: <span className="text-orange-400 font-bold">{selectedSize}</span> · ₹{(product.price_paise / 100).toLocaleString('en-IN')}
                </div>
              </div>
            </div>
            ...
            <div className="space-y-3 text-xs">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full px-3.5 py-2 rounded-xl bg-slate-900 border border-slate-800 focus:outline-none focus:border-orange-500 text-xs"
                />
              </div>
            ...
            <div className="pt-3">
              <button
                ...
                className="w-full py-3 rounded-xl bg-gradient-to-r from-orange-500 to-amber-600 hover:from-orange-600 hover:to-amber-700 text-white font-bold text-xs shadow-lg shadow-orange-500/20 transition-all flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50"
              >
